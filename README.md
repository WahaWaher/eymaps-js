jQuery EyMaps Plugin <sup>1.0.0</sup>
-------
_Плагин позволяет добовлять неограниченное число Яндекс карт без указания API наиболее простым и оптимальным способом (с точки зрения скорости загрузки сайта и удобного использования)._
...
* Возможность запретить зум карты до возникновения JS-события на ней (click, mouseover и т.д.) (Карта не мешает скролу колесиком выши, если она на всю ширину страницы)
